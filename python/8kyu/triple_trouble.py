...
Source:
https://www.codewars.com/kata/52aa64378d8ac51ec8000efb/train/python


Instructions:
A phone game Triple Town creates higher and higher value pieces whenever three or more identical pieces are clustered. Create a board_and_score_update method for a simple mockup of this game.
